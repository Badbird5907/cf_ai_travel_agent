/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 635bc3f4e1553ff325e050e203131bd9)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ACCOUNT_ID: string;
		EXA_API_KEY: string;
		PLANNER_AGENT: DurableObjectNamespace<import("./workers/app").PlannerAgent>;
		DATABASE: D1Database;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_ID" | "DATABASE_TOKEN" | "ACCOUNT_ID" | "EXA_API_KEY">> {}
}
